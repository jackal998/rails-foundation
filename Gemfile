...
# require: false because Bundler.require would otherwise dlopen libvips in
# EVERY Rails process at boot - including audits and one-off tasks that
# never touch an image. image_processing loads it on demand.
